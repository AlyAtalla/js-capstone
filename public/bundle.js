...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addLike\": () => (/* binding */ addLike)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\n\r\nconst addLike = async (item_id) => {\r\n  try {\r\n    await fetch(`${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/apps/${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/likes`, {\r\n      method: 'POST',\r\n      body: JSON.stringify({\r\n        item_id,\r\n      }),\r\n      headers: {\r\n        Accept: 'application.json',\r\n        'Content-Type': 'application/json',\r\n      },\r\n    });\r\n  } catch (err) {\r\n    console.error(err);\r\n  }\r\n};\r\n\n\n//# sourceURL=webpack://js-capstone/./src/api/addLike.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getComments\": () => (/* binding */ getComments),\n/* harmony export */   \"postComment\": () => (/* binding */ postComment)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\n\r\nconst getComments = async (id) => {\r\n  const response = await fetch(\r\n    `${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/apps/${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/comments?item_id=${id}`,\r\n  );\r\n  const data = await response.json();\r\n  return data;\r\n};\r\n\r\nconst postComment = async (id, name, comment) => {\r\n  const response = await fetch(`${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/apps/${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '../API-Data.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}/comments`, {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n    },\r\n    body: JSON.stringify({\r\n      item_id: id,\r\n      username: name,\r\n      comment,\r\n    }),\r\n  });\r\n  const data = await response.json();\r\n  return data;\r\n};\r\n\n\n//# sourceURL=webpack://js-capstone/./src/api/comments.js?");
